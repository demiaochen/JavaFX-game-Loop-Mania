...
public class LoopManiaWorldControllerLoader extends LoopManiaWorldLoader {
    ...
    public LoopManiaWorldControllerLoader(String filename)
        ...
        castleImage = new Image((new File("src/images/heros_castle.png")).toURI().toString());
    ...
    @Override
    public void onLoad(CastleBuilding castle) {
        ImageView view = new ImageView(castleImage);
